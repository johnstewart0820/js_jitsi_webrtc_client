...
if (config.UseHTTPS) {
	...
	app.use(function (req, res, next) {
		...
		res.setHeader("Content-Security-Policy", "script-src 'self' https://meet.jit.si https://code.jquery.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://webrtc.github.io https://stackpath.bootstrapcdn.com https://comm.encade.org 'unsafe-inline' 'unsafe-eval'");
		next();
	});
}
...
playerServer.on('connection', function (ws, req) {
	...
	function sendPlayersCount() {
		...
		setTimeout(sendPlayersCount, 300000);
	}
